...
async function formatBalance() {
  ...
  return (
    ...
    realBlock +
    `\n*\u0421\u0442\u043E\u0438\u043C\u043E\u0441\u0442\u044C \u043C\u043E\u0434\u0435\u043B\u0435\u0439:*\n` +
    `\u{1F5BC} Imagen 4 / NanoPro / NanoBanana 2 (Flow): 4 \u043A\u0440\u0435\u0434\n` +
    `\u{1F5BC} NanaBanana 2 (Flower) / ChatGPT / Grok: 1 \u043A\u0440\u0435\u0434\n` +
    `\u{1F3AC} Veo 3.1 Fast/Light/Ultra-Light/Flower: 1 \u043A\u0440\u0435\u0434\n` +
    `\u{1F3AC} Grok Video 480p: 1 \u043A\u0440\u0435\u0434 | 720p: 3 \u043A\u0440\u0435\u0434 (6\u0441/10\u0441)\n` +
    `\u{1F3AC} Omni Flash 4-8s: 1 \u043A\u0440\u0435\u0434 | 10s: 2 \u043A\u0440\u0435\u0434\n` +
    ...
    try {
      ...
      if (isScheduled && getTimeUntilNextHourUTC() < 5 * 60 * 1000) {
        ...
        await bot.sendMessage(chatId,
          ...
          `\u{1F4B3} \u041A\u0440\u0435\u0434\u0438\u0442\u044B: ${lastRefunded ? "\u2705 \u0432\u043E\u0437\u0432\u0440\u0430\u0449\u0435\u043D\u044B" : "\u274C \u043F\u043E\u0442\u0440\u0430\u0447\u0435\u043D\u044B"}`,
          {
            reply_markup: { inline_keyboard: [[{ text: "\u{1F504} \u041F\u0435\u0440\u0435\u0433\u0435\u043D\u0435\u0440\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u044D\u0442\u0443 \u0437\u0430\u0434\u0430\u0447\u0443", callback_data: `retry_err_${errKey}` }]] }
          }).catch(() => {});
        throw lastError;
...
async function genOneRaw(chatId, s, prompt, operation, model, isImage, index, total, batchIdx = null, imageRef = null, isScheduled = false) {
  ...
  const failMsg =
    ...
    `\u{1F4B3} ${lastRefunded ? "\u2705 \u0432\u043E\u0437\u0432\u0440\u0430\u0449\u0435\u043D\u044B" : "\u274C \u043F\u043E\u0442\u0440\u0430\u0447\u0435\u043D\u044B"}`;
  ...
  try {
    ...
    for (const res of pollResult.results) {
      if (res.data || res.download_path) {
        ...
        await sendV5Media(chatId, media, withSeedCaption(`\u{1F504} ${md(model.label)}\n\u{1F4DD} _${md(item.prompt.slice(0, 100))}_`, res, pollResult, requestSeed),
...
async function startTelegramPolling() {
  try {
    ...
    console.log("\u{1F916} FastGen Bot v5 \u0437\u0430\u043F\u0443\u0449\u0435\u043D! Polling active.");
  } catch (e) {
